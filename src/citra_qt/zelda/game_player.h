...
struct Player : public Actor {
    ...
    u8 gap_CEE[270];
    /// Z-target actor.
    Ptr<Actor> target_actor;
    u8 gap_E00[4];
    u32 field_E04;
    u32 field_E08;
    u32 field_E0C;
    u32 field_E10;
    Ptr<void(Player*, GlobalContext*)> state_handler;
    u8 gap_E18[4763];
    u8 field_20B3;
    u8 gap_20B4[61260];
